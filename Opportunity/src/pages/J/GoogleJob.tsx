...
<IonPage>
      <IonHeader>
        <IonToolbar>
          ...
          <IonTitle>Media Planer</IonTitle>
        </IonToolbar>
      </IonHeader>
      <IonContent className="ion-padding">
      <img className="m" src="/assets/google.jpg" alt="" />
...
<IonText color="primary">
      ...
      <IonLabel>
          ...
          <h2>1600 Amphitheatre Parkway,</h2>
          <h2>Mountain View,</h2>
          <h2>California</h2>
        </IonLabel>
        </div>

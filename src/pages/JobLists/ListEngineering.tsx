...
import { ENGINEERING_DATA } from "../SearchPages/SearchEngineering";
import {
  logoTwitter,
  logoInstagram,
  send,
...
import useFirebaseUpload from "../../hooks/EngineeringFileUpload";
import "./font.css";
const ListEngineering: React.FC = () => {
  const ListEngineeringJobDetailsId = useParams<{ engineeringId: string }>()
    .engineeringId;
  const [showToast1, setShowToast1] = useState(false);
  const ListEngineeringJobDetails = ENGINEERING_DATA.find(
    (job) => job.id === ListEngineeringJobDetailsId
  );
    ...
    <IonPage>
      <IonHeader>
        <IonToolbar>
          ...
          <IonTitle>{ListEngineeringJobDetails?.title}</IonTitle>
        </IonToolbar>
      </IonHeader>
      <IonContent>
        <IonGrid className="auto">
          <IonRow>
            <IonCol size-xs="12" size-md="9" offset-md="1.5">
              {ListEngineeringJobDetails?.about.map((about) => (
            ...
            <IonCol size-xs="12" size-md="9" offset-md="1.5">
              {ListEngineeringJobDetails?.overview.map((overview) => (
            ...
            <IonCol size-xs="12" size-md="9" offset-md="1.5">
              {ListEngineeringJobDetails?.requirements.map((requirements) => (
            ...
            <IonCol size-xs="12" size-md="4.5" offset-md="1.5">
              {ListEngineeringJobDetails?.skills.map((skills) => (
            ...
            <IonCol size-xs="12" size-md="4.5">
              {ListEngineeringJobDetails?.contact.map((contact) => (
...
export default ListEngineering;
